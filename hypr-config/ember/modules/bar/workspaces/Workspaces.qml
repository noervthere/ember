...
Item {
    ...
    property int lastHoveredWorkspaceIndex: 0

    onHoveredWorkspaceIndexChanged: {
        if (hoveredWorkspaceIndex >= 0)
            lastHoveredWorkspaceIndex = hoveredWorkspaceIndex;
    }
    ...
    // Horizontal hover workspace indicator (lightweight lower opacity circle following hovered workspace)
    StyledRect {
        id: hoverHighlightH
        variant: "primary"
        visible: orientation === "horizontal" && opacity > 0.001
        z: 1.5
        property real activeWorkspaceMargin: 4
        implicitWidth: workspaceButtonWidth - activeWorkspaceMargin * 2
        implicitHeight: workspaceButtonWidth - activeWorkspaceMargin * 2
        opacity: workspacesWidget.hoveredWorkspaceIndex >= 0 ? 0.35 : 0.0
        radius: implicitHeight / 2

        anchors.verticalCenter: parent.verticalCenter
        y: parent.height / 2 - implicitHeight / 2

        x: (workspacesWidget.hoveredWorkspaceIndex >= 0 ? workspacesWidget.hoveredWorkspaceIndex : workspacesWidget.lastHoveredWorkspaceIndex) * workspaceButtonWidth + activeWorkspaceMargin + widgetPadding
    ...
    // Vertical hover workspace indicator (lightweight lower opacity circle following hovered workspace)
    StyledRect {
        id: hoverHighlightV
        variant: "primary"
        visible: orientation === "vertical" && opacity > 0.001
        z: 1.5
        property real activeWorkspaceMargin: 4
        implicitWidth: workspaceButtonWidth - activeWorkspaceMargin * 2
        implicitHeight: workspaceButtonWidth - activeWorkspaceMargin * 2
        ...
        y: (workspacesWidget.hoveredWorkspaceIndex >= 0 ? workspacesWidget.hoveredWorkspaceIndex : workspacesWidget.lastHoveredWorkspaceIndex) * workspaceButtonWidth + activeWorkspaceMargin + widgetPadding
        ...
        Repeater {
            ...
            Button {
                ...
                HoverHandler {
                    onHoveredChanged: {
                        if (hovered) {
                            workspacesWidget.hoveredWorkspaceIndex = index;
                        } else if (workspacesWidget.hoveredWorkspaceIndex === index) {
                            workspacesWidget.hoveredWorkspaceIndex = -1;
                        }
                    }
                }
