...
Item {
    ...
    onWidthChanged: console.log("[NOTCH] width CHANGED:", width)
    onHeightChanged: console.log("[NOTCH] height CHANGED:", height)
    onImplicitWidthChanged: console.log("[NOTCH] implicitWidth CHANGED:", implicitWidth)
    onImplicitHeightChanged: console.log("[NOTCH] implicitHeight CHANGED:", implicitHeight)
