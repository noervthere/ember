...
NotchAnimationBehavior {
    ...
    readonly property var tabModel: [Icons.widgets, Icons.wallpapers, Icons.globe, Icons.heartbeat]
    readonly property int tabCount: tabModel.length
    readonly property int tabSpacing: 8

    readonly property int tabWidth: 48
    readonly property real nonAnimWidth: (GlobalStates.dashboardCurrentTab === 0 ? 600 : 400) + tabWidth + 16 // unified launcher tab is wider
    readonly property real nonAnimHeight: GlobalStates.dashboardCurrentTab === 2 ? 620 : (56 + 48 * 6)
    ...
    Row {
        ...
        Rectangle {
            ...
            Item {
                ...
                // Tab 2: Online Wallpapers
                TabLoader {
                    property int index: 2
                    sourceComponent: onlineWallpapersComponent
                    z: visible ? 1 : 0
                }
    ...
    Component {
        id: onlineWallpapersComponent
        OnlineWallpaperTab {
            currentScreenName: root.screenName
        }
    }
}
