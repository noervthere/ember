...
FocusScope {
    ...
    property var focusableElements: [
        ...
        },
        {
            id: "parallaxCheckbox",
            focusFunc: function () {
                parallaxCheckboxContainer.keyboardNavigationActive = true;
                parallaxCheckbox.forceActiveFocus();
            }
        },
        {
            id: "schemeSelector",
    ...
    function focusFilters() {
        // Always the last focusable element (keeps working if toggles are added/removed)
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            // Workspace parallax toggle (horizontal pan with active workspace)
            Item {
                id: parallaxCheckboxContainer
                ...
                StyledRect {
                    variant: parallaxCheckboxContainer.keyboardNavigationActive && parallaxCheckbox.activeFocus ? "focus" : "pane"
                    anchors.fill: parent
                    radius: Styling.radius(4)
                    opacity: 1.0
                    ...
                    RowLayout {
                        ...
                        Item {
                            ...
                            property bool checked: GlobalStates.wallpaperManager ? GlobalStates.wallpaperManager.parallaxEnabled : false

                            onActiveFocusChanged: {
                                if (!activeFocus) {
                                    parallaxCheckboxContainer.keyboardNavigationActive = false;
                                }
                            }
                            ...
                            Keys.onPressed: event => {
                                if (event.key === Qt.Key_Tab) {
                                    ...
                                    if (GlobalStates.wallpaperManager) {
                                        GlobalStates.wallpaperManager.parallaxEnabled = !GlobalStates.wallpaperManager.parallaxEnabled;
                                    }
                                    event.accepted = true;
                                } else if (event.key === Qt.Key_Escape) {
                                    parallaxCheckboxContainer.keyboardNavigationActive = false;
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    radius: Styling.radius(0)
                                    color: Colors.background
                                    visible: !parallaxCheckbox.checked
                                }
                                ...
                                StyledRect {
                                    ...
                                    radius: Styling.radius(0)
                                    visible: parallaxCheckbox.checked
                                    opacity: parallaxCheckbox.checked ? 1.0 : 0.0
                                    ...
                                    Text {
                                        ...
                                        font.family: Icons.font
                                        font.pixelSize: 20
                                        scale: parallaxCheckbox.checked ? 1.0 : 0.0
