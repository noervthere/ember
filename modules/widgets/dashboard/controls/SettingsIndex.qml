...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        { label: "Wallpaper Parallax", keywords: "parallax workspace pan zoom background movement", section: 4, subSection: "general", subLabel: "Theme > General", icon: Icons.image, isIcon: true },
        { label: "Wallpaper Zoom", keywords: "parallax zoom strength workspace wallpaper scale", section: 4, subSection: "general", subLabel: "Theme > General", icon: Icons.magnifyingGlass, isIcon: true },
