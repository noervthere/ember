...
StyledRect {
    ...
    ColumnLayout {
        ...
        LyricScroller {
            id: fullLyricScroller
            Layout.fillWidth: true
            Layout.preferredHeight: LyricsService.hasLyrics ? 80 : 0
            Layout.topMargin: LyricsService.hasLyrics ? -16 : 0
            Layout.bottomMargin: LyricsService.hasLyrics ? -4 : 0
            visible: LyricsService.hasLyrics
            compactMode: false
            textColor: Colors.overBackground
            activeLineColor: Colors.primary
            fallbackText: player.hasActivePlayer ? ((MprisController.activePlayer?.trackArtist ? MprisController.activePlayer.trackArtist + " - " : "") + (MprisController.activePlayer?.trackTitle || "")) : "Nothing Playing"
        }
