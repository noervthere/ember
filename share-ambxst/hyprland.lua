...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border = "rgb(ffb867)",
            inactive_border = "rgb(26211b)",
        },
        layout = "dwindle",
    },
    decoration = {
...
hl.bind("SUPER + SPACE", hl.dsp.exec_cmd("ambxst run launcher"))
hl.bind("SUPER + S", hl.dsp.exec_cmd("ambxst run dashboard"))
hl.bind("SUPER + D", hl.dsp.exec_cmd("ambxst run assistant"))
hl.bind("SUPER + V", hl.dsp.exec_cmd("ambxst run clipboard"))
hl.bind("SUPER + COMMA", hl.dsp.exec_cmd("ambxst run emoji"))
hl.bind("SUPER + W", hl.dsp.exec_cmd("ambxst run wallpapers"))
hl.bind("SUPER + Q", hl.dsp.exec_cmd("ambxst run overview"))
...
hl.bind("SUPER + R", hl.dsp.exec_cmd("ambxst run tools"))
